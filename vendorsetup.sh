...
rm -rf vendor/xiaomi/taoyao && git clone https://github.com/xiaomi-taoyao/vendor_xiaomi_taoyao.git vendor/xiaomi/taoyao
...
rm -rf hardware/xiaomi && git clone https://github.com/xiaomi-taoyao/hardware_xiaomi.git hardware/xiaomi
